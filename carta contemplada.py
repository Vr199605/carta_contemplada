...
def mostrar_simulador():
    # Estilo visual adaptado para visibilidade Light/Dark
    st.markdown(f"""
        <style>
            /* Cor de fundo principal removida para respeitar o tema do Streamlit (Light/Dark) */
            h1, h2, h3 {{
            ...
            /* Melhora visibilidade dos labels de métrica em ambos os temas */
            .stMetric label {{
                font-size: 1.1em;
                font-weight: 600;
            }}
    ...
    if st.sidebar.button("🚀 Simular"):
        ...
        # MUDANÇA: Lucro (Grupo Maldivas) alterado para Azul Escuro
        fig.add_trace(go.Bar(name='Lucro', x=['Simulação'], y=[lucro], marker_color=COR_AZUL_ESCURO))
        ...
        fig.update_layout(
            ...
            paper_bgcolor='rgba(0,0,0,0)', # Transparente para adaptar ao tema
        ...
        with st.expander("📋 Passo a Passo da Venda Contemplada"):
            ...
            **1️⃣ Contemplação da Carta** O primeiro passo é ter sua cota contemplada, o que pode acontecer de duas formas:
            ...
            **2️⃣ Solicitação do Extrato Financeiro da Cota** Após a contemplação, você solicita à administradora do consórcio o **extrato financeiro detalhado da cota**.  
            ...
            **3️⃣ Envio para Análise da Capital Invest** Você envia o extrato para a Capital Invest, que irá analisar cuidadosamente as condições da sua cota.  
            Isso inclui o valor líquido disponível, o histórico de pagamentos e possíveis pendências.

            **4️⃣ Proposta e Pagamento Inicial ao Cliente** Após a análise, fazemos uma **proposta de compra personalizada** da sua carta.  
